...
export let atomViewerPosition = new RetainedAtom<V4>("perspective.position", [0, 0, -100, -100]);

export let atomViewerRightward = new RetainedAtom<V4>("perspective.rightward", [1, 0, 0, 0]);
export let atomViewerUpward = new RetainedAtom<V4>("perspective.upward", [0, 1, 0, 0]);
export let atomViewerForward = new RetainedAtom<V4>("perspective.forward", [0, 0, -1, 0]);
/** direction in 4th dimension */
export let atomViewerWDirection = new RetainedAtom<V4>("perspective.direction", [0, 0, 0, 1]);

export let atomViewerScale = new RetainedAtom<number>("perspective.scale", 1);
